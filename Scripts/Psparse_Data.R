...
dir.create("DATA-R-P-Sparse") # Directory to save the data
...
save(Info_simulation, file = "DATA-R-P-Sparse/Info_simulation.RData")
...
results_sim1_data1 <- foreach(i=1:nrow(design_matrix_replication),
                              ...
                              .combine=rbind)%dopar%{
                                ...
                                save(out, file=paste0("DATA-R-P-Sparse/Psparse",i, ".RData"))
